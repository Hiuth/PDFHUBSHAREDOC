...
public enum ErrorCode {
    ...
    NOTI_LENGTH(1021, "Title and content must be at least 5 characters", HttpStatus.BAD_REQUEST),
    NOTI_EXISTED(1022, "Notification already exists", HttpStatus.CONFLICT),
    NOTI_NOT_EXISTED(1023, "Notification not exists", HttpStatus.NOT_FOUND),
